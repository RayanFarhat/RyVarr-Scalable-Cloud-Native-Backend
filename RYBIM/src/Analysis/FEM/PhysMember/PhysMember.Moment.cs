...
namespace RYBIM.Analysis
{
    public partial class PhysMember : Member3D
    {
        ...
        /// </summary>
        ///   <param name="D"> The direction in which to find the maximum moment. Must be one of MY or MZ</param>
        ...
        /// </summary>
        ///   <param name="D"> The direction in which to find the minimum moment. Must be one of MY or MZ</param>
